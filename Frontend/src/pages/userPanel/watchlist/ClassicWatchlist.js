...
import sellIcon from "../../../images/sell-svgrepo-com.svg";
...
const ClassicWatchlist = () => {
  ...
  const [searchedEstates, setSearchedEstates] = useState([
    { title: "bech home", country: "iran", city: "washington DC" },
  ]);
          ...
          <div className={styles.FirstPart}>
            <div className={styles.SelectDiv}>
              <div className={styles.dropdown} ref={dropdownRef}>
                ...
                >
                  <li onClick={() => countrySelectEventHandler("United state")}>
                    United state
                  </li>
                </ul>
              </div>
              ...
              <div className={styles.dropdown2} ref={dropdownRef2}>
                <div className={styles.selection2} onClick={toggleCityDropdown}>
                  <span className={styles.selectedOption2}>{city}</span>
                  <img
                    src={arrowDownIcon}
                    className={styles.ArrowIcon2}
                    alt="Arrow"
                    style={cityDropdown ? { transform: "rotate(180deg)" } : {}}
                  />
                </div>
                <ul
                ...
                >
                  <li
                    onClick={() => citySelectEventHandler("sistan balochestan")}
                  >
                    sistan balochestan
                  </li>
                </ul>
            ...
            <form className={styles.searchContainer}>
              ...
              />
              {searchedEstates.length > 0 && <SearchComponent />}
            </form>
          </div>
